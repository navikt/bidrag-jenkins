...
def call(body) {
    ...
    node {
        ...
        stage("#2: initialize") {
            pom = readMavenPomq file: 'pom.xml'
            println "POM props"
        ...
        stage("#5: release artifact") {
            Builder.releaseArtifact(this, isSnapshot, mvnImage, imageVersion, releaseVersion, environment, application, pom.version, "$HOME", dockerRepo)
        }
